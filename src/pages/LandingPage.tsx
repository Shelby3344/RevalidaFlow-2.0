...
export default function LandingPage() {
  ...
  const features = [
    ...
    {
      icon: CheckCircle2,
      title: "659 Checklists OSCE",
      description: "Checklists oficiais das principais bancas + PEPE. Avalie seu desempenho item por item.",
    ...
    {
      icon: Mic,
      title: "4.116 Questões Teóricas",
      description: "Banco completo de questões com gabarito comentado. Filtros por área e ano.",
      gradient: "from-orange-500 to-red-500"
    },
    {
      icon: BookOpen,
      title: "Resumos & Flashcards",
      description: "Resumos objetivos de cada tema. Flashcards com repetição espaçada.",
      gradient: "from-indigo-500 to-purple-500"
    },
    {
      icon: Trophy,
      title: "Comunidade & Ranking",
      description: "Chat global, ranking de estudos, conquistas e gamificação completa.",
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      {/* Navbar */}
      <nav className="fixed top-3 left-3 right-3 md:top-4 md:left-4 md:right-4 z-50">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-2 md:py-3 bg-background/80 backdrop-blur-lg border border-border/50 rounded-full">
          <div className="flex items-center justify-between">
            ...
            <Button 
              className="bg-cyan-500 hover:bg-cyan-600 text-white rounded-full px-4 md:px-6 text-sm md:text-base h-8 md:h-10"
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
            Treine com pacientes virtuais, pratique checklists OSCE e estude 
            de forma inteligente. A forma mais eficiente de se preparar.
          </p>
      ...
      <section id="stats" className="py-24 px-4 bg-card/30">
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <AnimatedStat value={659} label="Checklists OSCE" suffix="+" />
            <AnimatedStat value={4116} label="Questões Teóricas" suffix="" />
        ...
        <div className="h-screen max-w-4xl mx-auto">
          ...
          >
            <ScrollStackItem itemClassName="gradient-cyan">
              ...
              <h3>Treino com Paciente Virtual</h3>
              <p>
                Converse com pacientes virtuais usando sua voz. Respostas em tempo real 
            ...
            <ScrollStackItem itemClassName="gradient-purple">
              ...
              <h3>659+ Checklists OSCE</h3>
              <p>
                Todos os checklists oficiais das principais bancas do Revalida + estações PEPE. 
                Organizados por área com pontuação detalhada.
              </p>
              <div className="card-features">
                <span className="card-feature"><Check /> INEP 2020-2025</span>
                <span className="card-feature"><BarChart3 /> Pontuação detalhada</span>
                <span className="card-feature"><Target /> 5 áreas médicas</span>
              </div>
            </ScrollStackItem>
      ...
      <section className="py-24 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { step: 1, icon: Target, title: "Escolha o checklist", desc: "Selecione entre 659+ checklists organizados por área" },
              { step: 2, icon: Mic, title: "Treine com o paciente", desc: "Converse com o paciente virtual usando sua voz" },
            ...
            {[
              {
                ...
                avatar: "CS",
                text: "O treino com paciente virtual foi um diferencial enorme. Consegui praticar anamnese todos os dias sem depender de colegas. Aprovei de primeira!",
                rating: 5
              },
              {
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                answer: "Você conversa por voz com um paciente virtual que responde em tempo real. É como uma consulta médica real - você faz anamnese, solicita exames e recebe respostas naturais. Ao final, recebe uma avaliação detalhada do seu desempenho."
              },
              {
                question: "Os checklists são das bancas oficiais?",
                answer: "Sim! Temos 659+ checklists baseados nas principais bancas do Revalida (INEP 2020-2025) + estações PEPE. Cada checklist tem pontuação detalhada item por item, exatamente como na prova real."
              },
              {
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                A plataforma mais completa para sua aprovação no Revalida INEP.
              </p>
              <div className="flex items-center gap-3">
